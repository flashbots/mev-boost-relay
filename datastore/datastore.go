...
// Helpers for stats (not currently used)
// func (ds *Datastore) IncEpochSummaryVal(epoch uint64, field string, value int64) (newVal int64, err error) {
...
// func (ds *Datastore) SetEpochSummaryVal(epoch uint64, field string, value int64) (err error) {
...
// func (ds *Datastore) SetNXEpochSummaryVal(epoch uint64, field string, value int64) (err error) {
...
// func (ds *Datastore) IncSlotSummaryVal(slot uint64, field string, value int64) (newVal int64, err error) {
...
// func (ds *Datastore) SetSlotSummaryVal(slot uint64, field string, value int64) (err error) {
...
// func (ds *Datastore) SetNXSlotSummaryVal(slot uint64, field string, value int64) (err error) {
