...
var (
	...
	validPubKey = "0x8a1d7b8dd64e0aafe7ea7b6c95065c9364cf99d38470c12ee807d55f7de1529ad29ce2c422e0b65e3d5a05c02caca249"
	validPayloadRegisterValidator = types.SignedValidatorRegistration{
		Message: &types.RegisterValidatorRequestMessage{
			FeeRecipient: _HexToAddress("0xdb65fEd33dc262Fe09D9a2Ba8F80b329BA25f941"),
			Timestamp:    1234356,
			GasLimit:     278234191203,
			Pubkey: _HexToPubkey(validPubKey),
		},
	...
	validatorSet = map[PubkeyHex]validatorResponseEntry{
		PubkeyHex(validPubKey): {
			Validator: validatorPubKeyEntry{validPubKey},
		},
	}
