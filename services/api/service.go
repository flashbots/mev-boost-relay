...
func (api *RelayAPI) handleSubmitNewBlock(w http.ResponseWriter, req *http.Request) {
	...
	cont := api.checkSubmissionSlotDetails(w, log, headSlot, payload, submission)
	if !cont {
		return
	}
	...
	gasLimit, cont := api.checkSubmissionFeeRecipient(w, log, submission)
	if !cont {
		return
	}
	...
	cont = api.checkSubmissionPayloadAttrs(w, log, submission)
	if !cont {
		return
	}
